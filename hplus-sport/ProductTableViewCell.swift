...
//– In each quadrant, display an image (can be any image). 2 images can be file based and 1 image must be fetched from URL. 1 image must be picked using iOS photo gallery/camera whichever you can do.
//– Must work in both portrait and landscape orientations
//


//The UI must be code based, not storyboard/xib
//You must not use any third party libraries/pods
